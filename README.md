...
Furthermore, it eliminates the need for relative imports using dot notation. Consequently, import failures when the script is run as a standalone script are effectively resolved.
